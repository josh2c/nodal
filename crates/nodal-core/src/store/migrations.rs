...
pub const MIGRATIONS: &[Migration] = &[
    ...
    Migration {
        version: 7,
        name: "step output",
        sql: include_str!("migrations/0007_step_output.sql"),
    },
    Migration {
        version: 8,
        name: "trash pruned",
    ...
    Migration {
        version: 13,
        name: "unit slug open",
        sql: include_str!("migrations/0013_unit_slug_open.sql"),
    },
    Migration {
        version: 14,
        name: "lock session",
        sql: include_str!("migrations/0014_lock_session.sql"),
    },
    Migration {
        version: 15,
        name: "trash rested",
        sql: include_str!("migrations/0015_trash_rested.sql"),
    },
    Migration {
        version: 16,
        name: "event verdict",
        sql: include_str!("migrations/0016_event_verdict.sql"),
    },
    Migration {
        version: 17,
        name: "lock pid started",
        sql: include_str!("migrations/0017_lock_pid_started.sql"),
    },
];
