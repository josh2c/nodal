-- A frozen registry fixture: the schema and rows of version 3.
--
-- Data, not a script. It was written once, by the Nodal that appended migration
-- 3, and nothing regenerates it: a fixture rebuilt from today's migrations
-- moves whenever they move and proves nothing about the upgrade a person's
-- registry crosses. Edit it only to correct what version 3 really held.
--
