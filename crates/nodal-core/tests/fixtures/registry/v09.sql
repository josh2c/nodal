-- A frozen registry fixture: the schema and rows of version 9.
--
-- Data, not a script. It was written once, by the Nodal that appended migration
-- 9, and nothing regenerates it: a fixture rebuilt from today's migrations
-- moves whenever they move and proves nothing about the upgrade a person's
-- registry crosses. Edit it only to correct what version 9 really held.
--
...
, objective_epistemic TEXT
    CHECK (objective_epistemic IN ('observed', 'stated'))) STRICT;
...
INSERT INTO unit (id, project_id, slug, objective, branch, parent_branch, status, created_at, updated_at, objective_epistemic)
VALUES ('01J8Z6H0000000000000000002', '01J8Z6H0000000000000000001', 'fix-worker-import', 'fix the worker import', 'nodal/fix-worker-import', 'main', 'open', 1788688860, 1788688860, 'stated');
INSERT INTO unit (id, project_id, slug, objective, branch, parent_branch, status, created_at, updated_at, objective_epistemic)
VALUES ('01J8Z6H0000000000000000008', '01J8Z6H0000000000000000001', 'worker-import', 'import the workers', 'nodal/worker-import', 'main', 'archived', 1788688870, 1788688880, 'stated');
INSERT INTO unit (id, project_id, slug, objective, branch, parent_branch, status, created_at, updated_at, objective_epistemic)
VALUES ('01J8Z6H0000000000000000009', '01J8Z6H0000000000000000001', 'worker-import-2', 'import the workers', 'nodal/worker-import', 'main', 'open', 1788688890, 1788688890, 'stated');
INSERT INTO unit (id, project_id, slug, objective, branch, parent_branch, status, created_at, updated_at, objective_epistemic)
VALUES ('01J8Z6H0000000000000000041', '01J8Z6H0000000000000000001', 'retry-the-probe', 'retry the probe once', 'nodal/retry-the-probe', 'main', 'review', 1788688700, 1788688710, 'stated');
INSERT INTO unit (id, project_id, slug, objective, branch, parent_branch, status, created_at, updated_at, objective_epistemic)
VALUES ('01J8Z6H0000000000000000042', '01J8Z6H0000000000000000001', 'name-the-queue', 'name the queue after what it carries', 'nodal/name-the-queue', 'main', 'merged', 1788688600, 1788688610, 'stated');
INSERT INTO unit (id, project_id, slug, objective, branch, parent_branch, status, created_at, updated_at, objective_epistemic)
VALUES ('01J8Z6H0000000000000000043', '01J8Z6H0000000000000000001', 'spike-the-pool', 'spike a pool and throw it away', 'nodal/spike-the-pool', 'main', 'archived', 1788688500, 1788688520, 'stated');
