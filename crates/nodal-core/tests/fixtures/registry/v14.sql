-- A frozen registry fixture: the schema and rows of version 14.
--
-- Data, not a script. It was written once, by the Nodal that appended migration
-- 14, and nothing regenerates it: a fixture rebuilt from today's migrations
-- moves whenever they move and proves nothing about the upgrade a person's
-- registry crosses. Edit it only to correct what version 14 really held.
--
...
CREATE TABLE trash (
    ...
    expires_at     INTEGER NOT NULL
, pruned_bytes INTEGER NOT NULL DEFAULT 0) STRICT;
...
INSERT INTO trash (environment_id, unit_id, project_id, slug, home, path, snapshot, trashed_at, expires_at, pruned_bytes)
VALUES ('01J8Z6H0000000000000000011', '01J8Z6H0000000000000000008', '01J8Z6H0000000000000000001', 'worker-import', '/home/dev/.nodal/acme/e/01J8Z6H1', '/home/dev/.nodal/acme/trash/01J8Z6H1', NULL, 1788688960, 1789898560, 12884901888);
INSERT INTO trash (environment_id, unit_id, project_id, slug, home, path, snapshot, trashed_at, expires_at, pruned_bytes)
