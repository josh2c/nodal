-- A frozen registry fixture: the schema and rows of version 15.
--
-- Data, not a script. It was written once, by the Nodal that appended migration
-- 15, and nothing regenerates it: a fixture rebuilt from today's migrations
-- moves whenever they move and proves nothing about the upgrade a person's
-- registry crosses. Edit it only to correct what version 15 really held.
--
