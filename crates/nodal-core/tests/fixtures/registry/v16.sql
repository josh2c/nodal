-- A frozen registry fixture: the schema and rows of version 16.
--
-- Data, not a script. It was written once, by the Nodal that appended migration
-- 16, and nothing regenerates it: a fixture rebuilt from today's migrations
-- moves whenever they move and proves nothing about the upgrade a person's
-- registry crosses. Edit it only to correct what version 16 really held.
--
...
CREATE TABLE lock (
    ...
    host       TEXT    NOT NULL,
    expires_at INTEGER NOT NULL
, actor_kind TEXT, actor_name TEXT, pid INTEGER, taken_at INTEGER NOT NULL DEFAULT 0, refreshed_at INTEGER NOT NULL DEFAULT 0, session INTEGER) STRICT;
...
INSERT INTO lock (unit_id, host, expires_at, actor_kind, actor_name, pid, taken_at, refreshed_at, session)
VALUES ('01J8Z6H0000000000000000002', 'laptop', 1788692700, 'agent', 'claude-code', 4242, 1788689100, 1788689240, 4200);
