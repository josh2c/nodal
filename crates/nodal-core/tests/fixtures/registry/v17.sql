-- A frozen registry fixture: the schema and rows of version 17.
--
-- Data, not a script. It was written once, by the Nodal that appended migration
-- 17, and nothing regenerates it: a fixture rebuilt from today's migrations
-- moves whenever they move and proves nothing about the upgrade a person's
-- registry crosses. Edit it only to correct what version 17 really held.
--
...
, objective_epistemic TEXT
    CHECK (objective_epistemic IN ('observed', 'stated')), base_commit TEXT) STRICT;
...
CREATE TABLE session (
    ...
    ended_at       INTEGER
, pgid INTEGER CHECK (pgid IS NULL OR pgid > 1)) STRICT;
...
CREATE TABLE lock (
    ...
    host       TEXT    NOT NULL,
    expires_at INTEGER NOT NULL
, actor_kind TEXT, actor_name TEXT, pid INTEGER, taken_at INTEGER NOT NULL DEFAULT 0, refreshed_at INTEGER NOT NULL DEFAULT 0, session INTEGER, pid_started_at INTEGER) STRICT;
...
CREATE TABLE operation_step (
    ...
    updated_at   INTEGER NOT NULL, output TEXT,
...
CREATE TABLE trash (
    ...
    expires_at     INTEGER NOT NULL
, pruned_bytes INTEGER NOT NULL DEFAULT 0, rested TEXT NOT NULL DEFAULT '') STRICT;
...
VALUES ('01J8Z6H0000000000000000001', '/home/dev/acme', 'acme', '0f1e2d', 1788688800, 'github.com/acme/acme');
INSERT INTO base (id, project_id, ws_fingerprint, platform, commit_id, path, built_at, last_used, provenance)
VALUES ('01J8Z6H0000000000000000003', '01J8Z6H0000000000000000001', '7c1e9a2b', 'x86_64-unknown-linux-gnu', '9a3f1c2d4e5b6a7980c1d2e3f4a5b6c7d8e9f001', '/home/dev/.nodal/acme/b/7c1e9a2b', 1788688810, 1788688820, '{"nodal_version":"0.1.0-rc.1","install":[["pnpm","install","--frozen-lockfile"]],"warm":["pnpm","build"],"tools":{"pnpm":"9.12.3"},"recipe":"0f1e2d"}');
...
INSERT INTO unit (id, project_id, slug, objective, branch, parent_branch, status, created_at, updated_at, objective_epistemic, base_commit)
VALUES ('01J8Z6H0000000000000000002', '01J8Z6H0000000000000000001', 'fix-worker-import', 'fix the worker import', 'nodal/fix-worker-import', 'main', 'open', 1788688860, 1788688860, 'stated', '9a3f1c2d4e5b6a7980c1d2e3f4a5b6c7d8e9f001');
INSERT INTO unit (id, project_id, slug, objective, branch, parent_branch, status, created_at, updated_at, objective_epistemic, base_commit)
VALUES ('01J8Z6H0000000000000000008', '01J8Z6H0000000000000000001', 'worker-import', 'import the workers', 'nodal/worker-import', 'main', 'archived', 1788688870, 1788688880, 'stated', NULL);
INSERT INTO unit (id, project_id, slug, objective, branch, parent_branch, status, created_at, updated_at, objective_epistemic, base_commit)
VALUES ('01J8Z6H0000000000000000009', '01J8Z6H0000000000000000001', 'worker-import-2', 'import the workers', 'nodal/worker-import', 'main', 'open', 1788688890, 1788688890, 'stated', NULL);
INSERT INTO unit (id, project_id, slug, objective, branch, parent_branch, status, created_at, updated_at, objective_epistemic, base_commit)
VALUES ('01J8Z6H0000000000000000041', '01J8Z6H0000000000000000001', 'retry-the-probe', 'retry the probe once', 'nodal/retry-the-probe', 'main', 'review', 1788688700, 1788688710, 'stated', NULL);
INSERT INTO unit (id, project_id, slug, objective, branch, parent_branch, status, created_at, updated_at, objective_epistemic, base_commit)
VALUES ('01J8Z6H0000000000000000042', '01J8Z6H0000000000000000001', 'name-the-queue', 'name the queue after what it carries', 'nodal/name-the-queue', 'main', 'merged', 1788688600, 1788688610, 'stated', NULL);
INSERT INTO unit (id, project_id, slug, objective, branch, parent_branch, status, created_at, updated_at, objective_epistemic, base_commit)
VALUES ('01J8Z6H0000000000000000043', '01J8Z6H0000000000000000001', 'spike-the-pool', 'spike a pool and throw it away', 'nodal/spike-the-pool', 'main', 'archived', 1788688500, 1788688520, 'stated', NULL);
...
INSERT INTO lock (unit_id, host, expires_at, actor_kind, actor_name, pid, taken_at, refreshed_at, session, pid_started_at)
VALUES ('01J8Z6H0000000000000000002', 'laptop', 1788692700, 'agent', 'claude-code', 4242, 1788689100, 1788689240, 4200, 1788689090);
...
INSERT INTO operation_step (operation_id, position, key, state, updated_at, output)
VALUES ('01J8Z6H0000000000000000012', 0, 'branch', 'applied', 1788688845, NULL);
INSERT INTO operation_step (operation_id, position, key, state, updated_at, output)
VALUES ('01J8Z6H0000000000000000012', 1, 'materialize', 'applied', 1788688855, '{"ports":{"app":20002}}');
...
INSERT INTO trash (environment_id, unit_id, project_id, slug, home, path, snapshot, trashed_at, expires_at, pruned_bytes, rested)
VALUES ('01J8Z6H0000000000000000011', '01J8Z6H0000000000000000008', '01J8Z6H0000000000000000001', 'worker-import', '/home/dev/.nodal/acme/e/01J8Z6H1', '/home/dev/.nodal/acme/trash/01J8Z6H1', NULL, 1788688960, 1789898560, 12884901888, '{"kind":"safe","copies":[{"repository":"/home/dev/acme","references":["refs/remotes/origin/nodal/worker-import"],"commits":3}]}');
INSERT INTO trash (environment_id, unit_id, project_id, slug, home, path, snapshot, trashed_at, expires_at, pruned_bytes, rested)
VALUES ('01J8Z6H0000000000000000046', '01J8Z6H0000000000000000043', '01J8Z6H0000000000000000001', 'spike-the-pool', '/home/dev/.nodal/acme/e/01J8Z6H6', '/home/dev/.nodal/acme/trash/01J8Z6H6', 'refs/nodal/01J8Z6H0000000000000000043/wip', 1788688520, 1789898120, 0, '');
...
INSERT INTO event (id, unit_id, environment_id, ts, actor_kind, actor_name, kind, epistemic, body, refs, raw_ref)
VALUES ('01J8Z6H0000000000000000032', '01J8Z6H0000000000000000008', NULL, 1788688950, 'human', 'dev', 'verdict', 'observed', 'every commit of the home is on refs/remotes/origin/nodal/worker-import', '{"repository":"/home/dev/acme"}', NULL);
